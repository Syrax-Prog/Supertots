    ...
    <div class="sidebar">
        <header class="profile">
            <div class="gambar-user">
                <img src="img/parent/<?php echo $images; ?>" alt="Profile Picture">
            </div>
            <div class="user-info">
                <p><?php echo $role; ?></p>
                <p><?php echo $name; ?></p>
        ...
        <div class="side-content">
            <a href="home_parent.php" class="item">Homepage</a>
            <a href="profile.php" class="item">Profile</a>
            <a href="viewActivity.php" class="item">Student Activity</a>
            <a href="apParent.php" class="item">Academic Performance</a>
            <a href="chatParent.php" class="item">Chat</a>
        </div>
        <footer>

...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="side-content">
            <a href="home_teacher.php" class="item">Homepage</a>
            <a href="ListClassAttendance.php?name=<?php echo $name ?>" class="item">Attendance</a>
            <a href="teacherActivity.php" class="item">Activity</a>
            <a href="apTeacher.php" class="item">Academic Performance</a>
            <a href="chatTeacher.php" class="item">Chat</a>
            <a href="listStudentDetail.php?class=all" class="item">Students</a>
        </div>
        <footer>
